...
# Load models
Kidney_model = load_model(r"C:\Multiple Disease prediction.Project\Pickle File\kidney.pkl")
liver_model = load_model(r"C:\Multiple Disease prediction.Project\Pickle File\liver.pkl")
parkinson_model = load_model(r"C:\Multiple Disease prediction.Project\Pickle File\parkinsons_model.pkl")
